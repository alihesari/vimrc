...
* **Basic**: If you want something small just copy [basic.vim](https://github.com/alihesari/vimrc/blob/master/vimrcs/basic.vim) into your ~/.vimrc and you will have a great basic setup
...
The awesome version includes a lot of great plugins, configurations and color schemes that make Vim a lot better. To install it simply do following:
	...
	git clone https://github.com/alihesari/vimrc.git ~/.vim_runtime
...
The basic version is basically just one file and no plugins. You can check out [basic.vim](https://github.com/alihesari/vimrc/blob/master/vimrcs/basic.vim).

This is useful to install on remote servers where you don't need many plugins and you don't do many edits.

	git clone git://github.com/alihesari/vimrc.git ~/.vim_runtime
